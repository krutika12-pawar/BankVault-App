...
def render_splash_screen():
    if not st.session_state.get("Splash_screen", False):
        st.set_page_config(page_title="BankVault", page_icon="🏦", layout="wide")
        st.title("Welcome to BankVault!")
        st.header("Secure Banking Solutions")
    ...
    <style>
    body {
        background-color: #F0F8FF; /* Set the background color here (light blue in this example) */
    }
    </style>
    """
    ...
    col1, col2 = st.columns([1, 5])  # column widths
