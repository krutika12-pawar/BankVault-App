...
def Registration():
    ...
    with st.form("registration_form"):
        ...
        \n\n The bank will collect and use your personal information in accordance with its privacy policy.
        \n\n The bank will take reasonable measures to protect your personal and financial information from unauthorized access or disclosure.
        \n\n You are responsible for ensuring the security of your devices and internet connection when accessing the bank's online services.
        """
        st.markdown(terms_and_conditions)
        
        # Create a checkbox for terms and conditions
        agree_terms_conditions = st.checkbox("I agree to the terms and conditions")        
        ...
        if submitted:
            if not first_name:
                ...
                if email_exists(validated_email):
                    st.error("An account with this email address already exists. Please use a different email address.")
                    return
                ...
                # Validate terms and conditions after all other fields
                if not agree_terms_conditions:
    ...
    if os.path.exists(file_path):
        with open(file_path, "r") as file:
            for line in file:
                ...
                if len(fields) >= 7 and fields[2] == email_id:
                    return True
